...
if __name__ == '__main__':
    ...
    exp_pred_filenames = {"xgb_distance_and_angle_only": "./models/predictions/xgboost_distance_angle_only.csv"}
    title = "Visual Summary - XGBoost Models"
    image_dir = "./figures/advanced_models/"
    generate_adv_model_figures(experiment_prediction_filenames = exp_pred_filenames,title=title ,image_dir=image_dir )
