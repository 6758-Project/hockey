...
EXP_PARAMS = {"model_type": "Multi-layer Perceptron"}
...
def main(args):
    ...
    for model in args.model_type:
        ...
        params = {
            "solver": "adam",
            "hidden_layer_sizes": (input_layer, 2 * hidden_layer, output_layer),
            "activation": "logistic",
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-m", "--column-keywords", dest="model_type", type=str, nargs="+"
    )
